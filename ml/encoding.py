"""Shared title+diff pair-encoding — the ONE place the offline trainer/evaluator
builds its tokenizer input (FR-008).
...
model/encoding.py is a byte-for-byte twin of this file (the model service and the
